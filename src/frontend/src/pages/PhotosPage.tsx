...
export function PhotosPage({ onBack }: PhotosPageProps) {
  // Exactly 8 uploaded photos - no placeholders
  const photos = [
    '/assets/IMG_20250823_232818_582.jpg',
    '/assets/Snapchat-894825487.jpg',
    '/assets/Screenshot_2025-07-30-18-12-49-299_com.instagram.android.jpg',
    '/assets/Snapchat-860753736.jpg',
    '/assets/IMG-20250712-WA0264.jpg',
    '/assets/Screenshot_2025-08-18-01-57-49-211_gallery.gallerylock.vaultgallery.hidepictures.jpg',
    '/assets/IMG-20250712-WA0271-1.jpg',
    '/assets/IMG-20250712-WA0242-1.jpg'
  ];
