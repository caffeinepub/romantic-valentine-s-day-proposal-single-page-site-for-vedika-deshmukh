...
export class Backend implements backendInterface {
    ...
    async getSubmissionSummary(): Promise<Summary> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubmissionSummary();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAnswer(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
